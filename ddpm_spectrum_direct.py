...
from diffusion import Skewed_GaussianDiffusionTrainer_Spectrum_Multistep_Direct, GaussianDiffusionSampler
...
def train():
    ...
    trainer = Skewed_GaussianDiffusionTrainer_Spectrum_Multistep_Direct(
